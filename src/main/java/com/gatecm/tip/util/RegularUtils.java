...
//	private static final String regxpForImgTag = "<\\s*img\\s+([^>]*)\\s*>"; // 找出IMG标签
...
//	private static final String regxpForImaTagSrcAttrib = "src=\"([^\"]+)\""; // 找出IMG标签的SRC属性
	...
	public static String filterHtml(String str) {
		...
		while (matcher.find()) {
			matcher.appendReplacement(sb, BaseConstant.BLANK_STRING);
		}
		matcher.appendTail(sb);
		if (sb.length() > BaseConstant.INDEX_ABSTRACT_SHOW_LENGTH) {
			sb.setLength(BaseConstant.INDEX_ABSTRACT_SHOW_LENGTH);
			sb.append(BaseConstant.INDEX_ABSTRACT_END_ELILIPSIS);
		}
		return sb.toString();
	}
	...
	public static void main(String[] args) {
		// 按指定模式在字符串查找
		String line = "<p>This order was placed for QT3000! OK?</p><br /><p>sdfsdf</p>";
		System.err.println("==" + filterHtml(line) + "==");
